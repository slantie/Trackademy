...
export class CourseController {
    ...
    static async getCoursesBySubject(
        ...
        try {
            ...
            const courses = await courseService.getBySubject(
                subjectId,
                options
            );
    ...
    static async getCoursesByFaculty(
        ...
        try {
            ...
            const courses = await courseService.getByFaculty(
                facultyId,
                options
            );
    ...
    static async getCoursesBySemester(
        ...
        try {
            ...
            const courses = await courseService.getBySemester(
                semesterId,
                options
            );
    ...
    static async getCourseByIdWithRelations(
        ...
        try {
            const course = await courseService.getByIdWithRelations(
                req.params.id
            );
            res.status(200).json({
                status: "success",
